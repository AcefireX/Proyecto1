...
Empleado empleado1 = new Empleado("Juan", "Perez", 37688688, "san lorenzo 123", 24, 1155555555, 10000.0, 50, new DateTime(1960, 5, 22), supervisor);
supervisor.cargarEmpleadosLista(empleado);
supervisor.cargarEmpleadosLista(empleado1);
Console.WriteLine(supervisor.SumaSalarioEmpleados());
